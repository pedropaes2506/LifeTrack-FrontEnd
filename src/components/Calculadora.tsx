...
const Calculadora: React.FC = () => {
    ...
    const definirMetaHidratacao = () => {
        if (resultado) {
            alert(`Meta de hidratação definida: ${resultado.hidratacao}ml por dia!`);
            // Aqui você pode salvar no banco de dados ou contexto da aplicação
        }
    };
            ...
            <main className="dashboard-main-content">
                <div className="calculadora-container">
                    ...
                    <div className="coluna-esquerda">
                        <h1 className="titulo-principal">Calculadoras de Saúde</h1>
                        ...
                        {resultado && (
                            <div className="resultados-imc">
                                ...
                                <button 
                                    className="botao-meta"
                                    onClick={definirMetaHidratacao}
                                >
                                    Definir como meta para hidratação
                                </button>
                            </div>
                        )}
                    </div>
